 ...
 */
static void applyLEDpwm(Colour colour) {
    LL_TIM_OC_SetCompareCH1(TIM2, hexToCompareValue(colour.red));
    LL_TIM_OC_SetCompareCH2(TIM2, hexToCompareValue(colour.green));
    LL_TIM_OC_SetCompareCH3(TIM2, hexToCompareValue(colour.blue));
}
